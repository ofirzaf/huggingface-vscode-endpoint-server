...
class OpenVinoGenerator(GeneratorBase):
    def __init__(self, pretrained: str, draft: str = None, device: str = 'GPU', stop_strings: list = None, init_tokens=4096):
        ...
        if draft is not None:
            ...
            draft_scheduler_config.num_kv_blocks = init_tokens // 16
            draft_scheduler_config.dynamic_split_fuse = False
            draft_scheduler_config.max_num_batched_tokens = init_tokens
    ...
    def generate(self, query: str, parameters: dict) -> str:
        ...
        out = self.pipe.generate([query], generation_config, apply_chat_template=apply_chat_template)
