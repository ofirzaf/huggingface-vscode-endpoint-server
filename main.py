...
from generators import GeneratorBase, StarCoder, Qwen2VLGenerator#, OpenVinoGenerator
import json
...
async def api(request: Request):
    ...
    logger.info(f'{request.client.host}:{request.client.port} inputs = ')
...
def main():
    ...
    generator = Qwen2VLGenerator(args.pretrained)#, draft=args.draft)
